...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. You look at the price tag glued to the refrigerator. Fifty big ones?! Where'd they buy this refrigerator, some kind of expensive place?[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can see a counter. The counter is usual.[if there is something on the s_1] On the counter you see [a list of things on the s_1].[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1] But the thing hasn't got anything on it. What, you think everything in TextWorld should have stuff on it?[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " You see a stove. Why don't you take a picture of it, it'll last longer! [if there is something on the s_2]On the stove you can see [a list of things on the s_2].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2]But oh no! there's nothing on this piece of trash. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " Hey, want to see a kitchen island? Look over there, a kitchen island. The kitchen island is usual.[if there is something on the s_3] On the kitchen island you can see [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Guess what, you are in a place we're calling a bedroom. You begin looking for stuff.

 You bend down to tie your shoe. When you stand up, you notice a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. You can't wait to tell the folks at home about this![end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You rest your hand against a wall, but you miss the wall and fall onto a king-size bed. The king-size bed is typical.[if there is something on the s_0] On the king-size bed you can see [a list of things on the s_0]. Now that's what I call TextWorld![end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0] The king-size bed appears to be empty. Hm. Oh well[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You're now in the backyard.
 ...
 Oh, great. Here's a set of chairs. [if there is something on the s_10]On the set of chairs you make out [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. Why don't you take a picture of it, it'll last longer! [if there is something on the s_8]On the bbq you can see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You make out a patio table. [if there is something on the s_9]On the patio table you can make out [a list of things on the s_9]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've entered a living room. The room is well lit.

 You can see a couch. The couch is ordinary.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You hear a noise behind you and spin around, but you can't see anything other than a low table. The low table is standard.[if there is something on the s_6] On the low table you can make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a tv. The tv is ordinary.[if there is something on the s_7] On the tv you see [a list of things on the s_7], so there's that.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A typical kind of place. You start to take note of what's in the room.
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You can see a sink. [if there is something on the s_4]On the sink you see [a list of things on the s_4].[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4]But oh no! there's nothing on this piece of junk. Oh! Why couldn't there just be stuff on it?[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "that's an usual bell pepper!".
...
The description of o_1 is "The soap bar appears to fit in here".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First stop, open the antique trunk in the bedroom. Then, take the old key from the antique trunk. And then, unlock the wooden ".
The objective part 1 is some text that varies. The objective part 1 is "door in the bedroom with the old key. After unlocking the wooden door, open the wooden door. And then, head east. That done, ensure that the screen door is open. After that, make an attempt to go east".
The objective part 2 is some text that varies. The objective part 2 is ". Then, go south. And then, recover the half of a bag of chips from the floor of the garden. After that, make an effort to head north. Then, go to the west. And then, rest the half of a bag of chips o".
